...
Note that the `RNeo4j` package needs to be installed from github, this was done automatically for a Vagrant-based HitWalker2 build but can also be done manually using the `devtools` package:
