...
Note that the \texttt{RNeo4j} package needs to be installed from github, which can be done as follows:
...
targ.matches <- lapply(drug.names, function(x){
    ...
    cypher(graph, "MATCH (gene:EntrezID)-[r:REFFERED_TO]-(symb) WITH gene,symb, r,
